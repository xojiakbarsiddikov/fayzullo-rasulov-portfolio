    ...
    <template>
        <div class="relative overflow-hidden h-20rem bg-primary flex flex-column align-items-center justify-content-center border-round" style="margin-bottom: 3rem !important;">
            ...
            <div class="font-bold mb-3 text-6xl z-1" data-aos="fade-down"><span class="blue-color_2">College Applicant - </span> RASULOV FAYZULLO</div>
        ...
        <div class="grid">
            <div class="col-12 md:col-6 xl:col-3"  data-aos="fade-up">
                <router-link to="/ielts-certificate">
                    <div class="card h-full padding-eccomerce">
            ...
            <div class="col-12 md:col-6 xl:col-3" style="cursor: pointer;" data-aos="fade-up">
                <router-link to="/sport-certificate">
                    ...
                    <div class="flex justify-content-between mt-3">
                        <div class="w-6">
                            <img src="/demo/images/world-taekwondo-logo.png" alt="sport-logo" style="width: 100%; height: 100%;">
                        </div>
                        <span class="text-2xl font-bold text-900 center text-h2"><span style="color: #4dbcff;">SPORT</span> CERTIFICATES</span>
                        <div class="w-6">
                            <img src="/demo/images/taekwondo-logo2.png" alt="sport-logo" style="width: 100%; height: 100%;">
                        </div>
                    </div>
                </div>  
                </router-link>
            ...
            <div class="col-12 md:col-6 xl:col-3" style="cursor: pointer;" data-aos="fade-down">
                <router-link to="/other-certificate">
                    ...
                    <div class="flex justify-content-between mt-3">
                        <div class="w-6">
                            <img src="/demo/images/certified-logo2.png" alt="certified-logo" style="width: 100%; height: 100%;">
                        </div>
                        <span class="text-2xl font-bold text-900 center text-h2"><span style="color: #ffb52c;">OTHER EXTRA</span> CERTIFICATES</span>
                        <div class="w-6">
                            <img src="/demo/images/certified-logo.png" alt="certified-logo" style="width: 100%; height: 100%;">
                        </div>
                    </div>
                </div>  
                </router-link>
            </div>
            <div class="col-12 md:col-6 xl:col-3"  data-aos="fade-right">
                <router-link to="/programming-certificate">
                    ...
                    <div class="flex justify-content-between align-items-center" style="width: 100%; height: 100%;">
                        ...
                        <img src="/demo/images/programming2.png" class="media-height" alt="extra-certificate-logo">
                    </div>
                </div>
                </router-link>
            </div>
            <div class="col-12 md:col-6 xl:col-3" style="cursor: pointer;" data-aos="fade-up">
                <router-link to="/school-certificate">
                    <div class="h-full card padding-eccomerce" style="padding: 1.5rem 1rem!important;">
                    <div class="flex justify-content-between mt-3">
                        <div class="w-6">
    ...
    .backround {
        background: url("/public/demo/images/ielts-logo.png") !important;
