            ...
            <div class="card">
                <h5><span class="blue-color text-left">SAT</span>CERTIFICATES</h5>
                    ...
                    <div class="flex justify-content-space-between text-warpper">
                        <h5 class="text"><span class="blue-color">2nd</span> ATTEMPT (TOTAL SCORE:<span class="blue-color text-right">1090</span>)</h5>
                        <h5 class="text"><span class="blue-color">1st</span> ATTEMPT (TOTAL SCORE:<span class="blue-color text-right">1070</span>)</h5>
                    </div>
            </div>
        </div>
    </div>
